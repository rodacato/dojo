// =============================================================================
// SQL Deep Cuts — scroll seed data
//
// Executed in SQLite (Piston's sql runtime). KataCode pattern:
...
export const SQL_DEEP_CUTS_LESSONS = [
  { id: LESSON_1_ID, scrollId: COURSE_ID, order: 1, title: 'Window Functions' },
  { id: LESSON_2_ID, scrollId: COURSE_ID, order: 2, title: 'CTEs and Readable Queries' },
  { id: LESSON_3_ID, scrollId: COURSE_ID, order: 3, title: 'Real-World Analysis' },
]
