// =============================================================================
// Python for the Practiced — scroll seed (PRD 025 Option A skeleton)
//
...
//
// Status: draft. Ships with 1 read + 1 kata (dataclass) in this sprint;
// `match` + `Enum` katas land in S021. Flipping to `published` is a
...
export const PYTHON_LESSONS = [
  { id: LESSON_1_ID, scrollId: COURSE_ID, order: 1, title: 'Modern Idioms' },
]
