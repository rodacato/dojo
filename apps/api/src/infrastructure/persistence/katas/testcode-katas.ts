...
export const testCodeKatas: SeedKata[] = [
  // ---------------------------------------------------------------------------
  // 062 — Flatten Nested Arrays (TypeScript, easy)
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-062-flatten-nested-arrays'),
...
`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-063-retry-with-backoff'),
...
`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-064-group-by-with-reduce'),
...
`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-065-debounce-function'),
...
`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-066-fizzbuzz-without-conditionals'),
...
`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-067-parse-key-value-config'),
...
`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-068-parse-csv-without-libraries'),
...
`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-069-matrix-rotation-in-place'),
...
`,
    variations: [
      ...
      },
      {
        ...
        ownerContext:
          'Evaluate whether the solution truly uses O(1) extra space. Creating a list comprehension for a new matrix and then copying back is O(n²) space even if you overwrite the original. The in-place constraint is the entire point of this kata. Bonus: does the developer handle the 1x1 edge case without special-casing it?',
      },
    ],
  },
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-070-bounded-worker-pool'),
...
`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-072-custom-error-types'),
...
`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-073-rank-employees-by-department'),
...
`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-074-find-churned-users'),
...
`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-075-recursive-cte-org-chart'),
...
`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-076-cte-refactor'),
    title: 'CTE Refactor',
