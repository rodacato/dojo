...
export const sqlAdvancedKatas: SeedKata[] = [
  // ---------------------------------------------------------------------------
  // 082 — Running Monthly Totals (SQL, medium)
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-082-running-monthly-totals'),
...
INSERT INTO _ok VALUES ((SELECT CASE WHEN
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-083-month-over-month-lag'),
...
INSERT INTO _ok VALUES ((SELECT CASE WHEN
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-084-salary-percentile-buckets'),
