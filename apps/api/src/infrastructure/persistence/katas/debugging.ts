...
export const debuggingKatas: SeedKata[] = [
  // ---------------------------------------------------------------------------
  // 077 — Fix: Off-by-one in pagination (TypeScript, easy)
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-077-fix-pagination-offset'),
...
console.log('All tests passed')`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-078-fix-sort-mutation'),
...
console.log('All tests passed')`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-079-fix-closure-var'),
...
console.log('All tests passed')`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-080-fix-negative-modulo'),
...
console.log('All tests passed')`,
  ...
  // ---------------------------------------------------------------------------
  {
    id: uuidv5('kata-081-fix-object-equality'),
