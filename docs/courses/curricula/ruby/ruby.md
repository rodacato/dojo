...
- **Predict step count: 4 of 25 = 16%.** Slightly above the 10-15% target in [`../../README.md`](../../README.md) §4.3 "Step type distribution guidelines". Defensible because the Ruby surprise surface is large and Lesson 0's predict is an orientation tool, not a syntax check.
